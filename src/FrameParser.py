...
# Initialize counts
count_data = {
    "ShadowDepthPass": {"draw_commands": 0, "triangles": 0, "static_meshes": 0, "static_mesh_triangles": 0, "skeletal_meshes": 0, "skeletal_mesh_triangles": 0},
    "MobileRenderPrePass": {"draw_commands": 0, "triangles": 0, "static_meshes": 0, "static_mesh_triangles": 0, "skeletal_meshes": 0, "skeletal_mesh_triangles": 0},
    "MobileBasePass": {"draw_commands": 0, "triangles": 0, "static_meshes": 0, "static_mesh_triangles": 0, "skeletal_meshes": 0, "skeletal_mesh_triangles": 0},
    "Translucency": {"draw_commands": 0, "triangles": 0, "static_meshes": 0, "static_mesh_triangles": 0, "skeletal_meshes": 0, "skeletal_mesh_triangles": 0}
}

def process_draw_command(line, current_pass_data, is_static_mesh, is_skeletal_mesh):
...
for line in log_data.splitlines():
    ...
    if "ShadowDepthPass" in line:
        ...
        if current_pass is not None:
            process_draw_command(line, count_data[current_pass], is_static_mesh, is_skeletal_mesh)
        is_static_mesh = False
        is_skeletal_mesh = False

# Calculate totals
total_counts = {"draw_commands": 0, "triangles": 0, "static_meshes": 0, "static_mesh_triangles": 0, "skeletal_meshes": 0, "skeletal_mesh_triangles": 0}
...
with open(csv_file_path, 'w', newline='') as csvfile:
    ...
    csv_writer.writerow(["Rendering Stage", "Draw Commands", "Triangles", "StaticMesh Objects", "StaticMesh Triangles", "SkeletalMesh Objects", "SkeletalMesh Triangles"])
    for pass_name, data in count_data.items():
        csv_writer.writerow([pass_name, data['draw_commands'], data['triangles'], data['static_meshes'], data['static_mesh_triangles'], data['skeletal_meshes'], data['skeletal_mesh_triangles']])
    csv_writer.writerow(["----------------------------------------------------", "", "", "", "", "", ""])
    csv_writer.writerow(["Total", total_counts['draw_commands'], total_counts['triangles'], total_counts['static_meshes'], total_counts['static_mesh_triangles'], total_counts['skeletal_meshes'], total_counts['skeletal_mesh_triangles']])
